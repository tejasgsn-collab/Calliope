...
"""
This version(5) of the Inertial prototype expands on the previous version, adding a prototype variable viewer,
akin to Spyder. It uses the Viewer module and creates a tkinter window to view the names of variables used in 
the code run, as well as their types and values. Version 6 aims to evolve on this, using a Qt based viewer instead, and will aim to put it in it's own expandable section, rather than a seperate window.
"""
...
class Inertial(QMainWindow):
    ...
    def _process_finished(self):
        ...
        variables = convert(self.Variables)
        Viewer = v.VariableViewer()
        Viewer.alter(variables)
        Viewer.mainloop()
